        ...
        return filteredAssets.length === 0 ? (
          <div className="text-center py-12 card">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">
              {assets.length === 0 ? 'No Liabilities Yet' : 'No Liabilities in This Category'}
            </h3>
            <p className="text-gray-600 mb-6">
              {assets.length === 0 
                ? 'Start by adding your first mortgage or loan'
                : 'Try selecting a different category or add a new liability'
              }
            </p>
            <button
              onClick={handleAddNew}
            ...
            >
              <FontAwesomeIcon icon={faPlus} className="mr-2" />
              {assets.length === 0 ? 'Add Your First Liability' : 'Add Liability'}
            </button>
          </div>
        ) : (
