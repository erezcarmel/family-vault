        ...
        return filteredAssets.length === 0 ? (
          <div className="text-center py-12 card">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">
              {assets.length === 0 ? 'No Money Accounts Yet' : 'No Accounts in This Category'}
            </h3>
            <p className="text-gray-600 mb-6">
              {assets.length === 0 
                ? 'Start by adding your first bank account or investment account'
                : 'Try selecting a different category or add a new account'
              }
            </p>
            <button
            ...
            >
              ...
              {assets.length === 0 ? 'Add Your First Account' : 'Add Account'}
            </button>
          </div>
        ) : (
